...
//      subtitle: Text(widget.document['position'] as String),
//      leading: Container(
//        width: 100,
//        height: 100,
...
//            CameraPosition(
//              target: LatLng(
//                widget.document['detail'].latitude as double,
//                widget.document['detail'].longitude as double,
//              ),
//              zoom: 16,
//            ),
//          ),
...
//        position: LatLng(
//          document['position'].latitude as double,
//          document['position'].longitude as double,
//        ),
//        infoWindow: InfoWindow(
//          title: document['name'] as String,
//          snippet: document['name'] as String,
//        ),
//      ))
//          .toSet(),
